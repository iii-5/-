...
#CAMERA
CAMERA_TYPE = "None"   # (PICAM|WEBCAM|CVCAM|CSIC|V4L|D435|MOCK|IMAGE_LIST)
IMAGE_W = 160
IMAGE_H = 120
...
DONKEY_GYM = True
DONKEY_SIM_PATH = "C:/Users/ioyt8/Downloads/DonkeySimWin/DonkeySimWin/donkey_sim.exe" #"/home/tkramer/projects/sdsandbox/sdsim/build/DonkeySimLinux/donkey_sim.x86_64" when racing on virtual-race-league use "remote", or user "remote" when you want to start the sim manually first.
...
RL_MODE = True  # 設為 True 啟用 RL 強化學習訓練
RL_ALGO = 'PPO'  # 可選: 'PPO', 'A2C', 'DDPG', 'SAC', 'TD3'
RL_TOTAL_TIMESTEPS = 50_0000  # 訓練步數
RL_MODEL_PATH = os.path.join(MODELS_PATH, 'rl_model.zip')  # RL 模型儲存路徑
RL_ENV_NAME = DONKEY_GYM_ENV_NAME  # 預設用 config 裡的 gym 環境名稱
RL_CHECKPOINT_DIR = 'checkpoints'  # checkpoint 存放資料夾
RL_CHECKPOINT_FREQ = 2_000       # 每幾步存一次 checkpoint
